...
# Script Deploy Lenteramaron
# Cara penggunaan: ./deploy.sh
# Pastikan script ini dijalankan dari dalam root folder project (Lenteramaron)

# Konfigurasi Path (Sesuaikan jika perlu)
# Asumsi: Folder project 'Lenteramaron' dan 'public_html' berada di level yang sama di hosting
PROJECT_FOLDER="Lenteramaron"
