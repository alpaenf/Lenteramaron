...
import { BookOpen, Users, UserCheck, BookMarked, TrendingUp, CheckCircle, Clock, ChevronDown, Calendar } from 'lucide-vue-next';
                ...
                <div class="lg:col-span-8 bg-surface-container-lowest p-6 rounded-2xl border border-outline-variant/40 shadow-xs space-y-4">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        <div class="relative inline-flex items-center">
                            ...
                            <select 
                                v-model="chartPeriod" 
                                class="appearance-none bg-surface-container-low hover:bg-surface-container border border-outline-variant/60 rounded-xl text-xs font-bold text-on-surface pl-8 pr-8 py-2 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary cursor-pointer transition-all shadow-2xs"
                            >
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2.5 text-on-surface-variant">
