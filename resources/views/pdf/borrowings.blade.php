...
<head>
    ...
    <style>
        ...
        /* Badges */
        .badge { padding: 2px 7px; border-radius: 4px; font-size: 9.5px; font-weight: 700; display: inline-block; text-transform: capitalize; }
        .badge-dipinjam { background-color: #e0f2fe; color: #0369a1; }
        .badge-dikembalikan { background-color: #dcfce7; color: #15803d; }
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="18%" align="left">NO. TRANSAKSI</th>
                <th width="24%" align="left">NAMA ANGGOTA</th>
                <th width="26%" align="left">JUDUL BUKU</th>
                <th width="12%" align="center">TGL PINJAM</th>
                <th width="12%" align="center">JATUH TEMPO</th>
        ...
        <tbody>
            @forelse($data as $index => $item)
                <tr>
                    ...
                    <td style="font-family: monospace; font-weight: bold; color: #0369a1;">{{ $item->transaction_no }}</td>
            ...
            @empty
                <tr>
                    <td colspan="7" align="center" style="padding: 20px; color: #94a3b8;">Tidak ada data peminjaman pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
