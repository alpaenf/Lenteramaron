...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 5px;">LAPORAN PENGEMBALIAN BUKU</h3>
        ...
        <tbody>
            @forelse($data as $index => $item)
                <tr>
                    ...
                    <td align="center">{{ $item->late_days }} hari</td>
                </tr>
            @empty
                <tr>
                    <td colspan="7" align="center">Tidak ada data pengembalian pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
